...
def getMail(mailhost, account, password, diskroot, port = 993, ssl = 1):
    ...
    # count = 0
    # for i in imapServer.list():
    #     print count
    #     count += 1
    #     print i
    #
    #
    # status, msgs = imapServer.select('INBOX')
    # print status
    # if status != 'OK':
    #     print 'haha'
    #     return
...
if __name__ =="__main__":
    ...
    # getMail('pop.qq.com', '874442445@qq.com', 'wds9208', mypath, 993, 1)
    #126邮箱登陆没用ssl
    getMail('imap.126.com', '18188609675@126.com', 'wds2006sdo', mypath, 143, 0)
